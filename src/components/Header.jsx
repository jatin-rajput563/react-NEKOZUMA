          ...
          <div className="flex flex-wrap flex-row -mx-3">
            <div className="full">
              <div className="pt-[164px] max-lg:pt-[60px]">
                ...
                />
                <button className="relative inline-block text-white text-base font-semibold py-[7.5px] px-[19.5px] rounded-[12px] mt-[43px] max-[500px]:mt-[16px] bg-[#245AAB] overflow-hidden transition-all duration-300 group hover:scale-105 hover:shadow-[0_0_15px_#00c8ff80]">
